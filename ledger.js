...
const cloudErrText = (msg) => {
  const m = String(msg || "");
  if (/逾時/.test(m)) return "\u9023\u7DDA\u903E\u6642,\u8ACB\u6AA2\u67E5\u7DB2\u8DEF\u5F8C\u91CD\u8A66";
  if (/401|403|token|未載入|過期/.test(m)) return "\u9023\u7DDA\u904E\u671F,\u8ACB\u91CD\u65B0\u9023\u7D50 Google Drive";
  if (/404/.test(m)) return "\u627E\u4E0D\u5230\u9019\u4EFD\u5099\u4EFD,\u53EF\u80FD\u5DF2\u88AB\u522A\u9664";
  if (/網路|失敗/.test(m)) return "\u9023\u7DDA\u5931\u6557,\u8ACB\u6AA2\u67E5\u7DB2\u8DEF\u5F8C\u91CD\u8A66";
  return "\u64CD\u4F5C\u5931\u6557,\u8ACB\u7A0D\u5F8C\u518D\u8A66";
};
...
function App() {
  ...
  const [blockOrder, setBlockOrder] = useState(() => {
    const defaults = {
      ...
      addTxn: ["amount", "typeToggle", "date", "category", "subCategory", "note", "account", "spacer1", "spacer2"]
    };
    ...
    try {
      ...
      if (isEmptyState) {
        ...
        if (existing) {
          ...
          const prevHasData = prev.transactions && prev.transactions.length > 0 || prev.accounts && prev.accounts.length > 0 || prev.holdings && prev.holdings.length > 0 || prev.trades && prev.trades.length > 0;
          if (prevHasData) {
  ...
  return /* @__PURE__ */ React.createElement(LinkContext.Provider, { value: linkCtxValue }, /* @__PURE__ */ React.createElement("div", { style: styles.root }, /* @__PURE__ */ React.createElement(Style, { theme, numFont }), /* @__PURE__ */ React.createElement(
    ...
    HoldingDetailSheet,
    {
      ...
      onEditSubTag: (holding) => setHoldingSubTagPickerSheet({ holding })
    }
  ...
  })(), holdingSubTagPickerSheet && /* @__PURE__ */ React.createElement(
    HoldingSubTagPickerSheet,
    {
      state,
...
function ConfirmDialogRenderer({ dialog, onClose }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { "data-picker-backdrop": "true", style: styles.pickerBackdrop, onClick: onClose }, /* @__PURE__ */ React.createElement("div", { style: styles.pickerCard, onClick: (e) => e.stopPropagation(), ...swipe }, /* @__PURE__ */ React.createElement("div", { style: { ...styles.pickerTitle, fontSize: 17, fontWeight: 700, padding: "14px 16px 12px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--text)" } }, (() => {
  ...
  } }, dialog.bigNumber.value), dialog.bigNumber.label && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-faint)", letterSpacing: 0.5 } }, dialog.bigNumber.label)), dialog.messageList && (() => {
    const ml = dialog.messageList;
    const styled = !!ml.styled;
    const hlWarn = Array.isArray(dialog.highlightWords) ? dialog.highlightWords.filter(Boolean) : [];
    const hlSafe = Array.isArray(dialog.highlightWordsSafe) ? dialog.highlightWordsSafe.filter(Boolean) : [];
    const renderHL = (text) => {
      if (!text || !styled || hlWarn.length === 0 && hlSafe.length === 0) return text;
      const esc = (s) => s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
      const all = [...hlWarn, ...hlSafe].sort((a, b) => b.length - a.length);
      const re = new RegExp("(" + all.map(esc).join("|") + ")", "g");
      const warnSet = new Set(hlWarn);
      const safeSet = new Set(hlSafe);
      return text.split(re).map((part, i) => {
        if (!part) return null;
        if (warnSet.has(part)) {
          return /* @__PURE__ */ React.createElement("span", { key: i, style: { color: "var(--pink)", fontWeight: 700 } }, part);
        }
        if (safeSet.has(part)) {
          return /* @__PURE__ */ React.createElement("span", { key: i, style: { color: "var(--mint)", fontWeight: 700 } }, part);
        }
    ...
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      flexDirection: "column",
      gap: 6
    } }, ml.items.map((it, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { color: "var(--text)", fontWeight: 500 } }, it)))), ml.after && /* @__PURE__ */ React.createElement("div", null, renderHL(ml.after)));
...
function Block({ blockKey, title, headerRight, editMode, isFirst, isLast, onMoveUp, onMoveDown, onReorder, children, inline, compactInline, disableReorder }) {
  ...
  if (inline && editMode && !disableReorder && !compactInline) {
    return /* @__PURE__ */ React.createElement(
      "div",
      {
        ref: elRef,
      ...
      title && /* @__PURE__ */ React.createElement("div", { style: styles.blockInlineTitle }, /* @__PURE__ */ React.createElement("span", { style: { ...styles.blockHandle, marginRight: 6 } }, "\u2630"), title),
      /* @__PURE__ */ React.createElement("div", { style: { ...styles.blockInlineContent, pointerEvents: "none" } }, children)
    );
  }
...
function HoldingDetailSheet({ state, holding, onClose, onUpdateMarketValue, onBuyMore, onSell, onDeleteTrade, onEditHolding, onEditTrade, onEditSubTag, setConfirmDialog }) {
  const swipe = useSwipeBack(onClose);
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetScroll }, /* @__PURE__ */ React.createElement("div", { style: {
      ...
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, color: "var(--text-dim)", width: 56, flexShrink: 0 } }, "\u5206\u985E"),
      /* @__PURE__ */ React.createElement("div", { style: {
        flex: 1,
        fontSize: 15,
        fontWeight: 500,
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetScroll }, /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 16px 0", fontSize: 12, color: "var(--text-faint)" } }, "\u7D66 ", holding.symbol, " \u5206\u5230\u81EA\u8A02\u7684\u4E3B\u984C\u985E\u5225,\u5982 \u592A\u7A7A / AI / \u6A5F\u5668\u4EBA / \u7F8E\u50B5 \u7B49\u3002"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6, padding: 12 } }, /* @__PURE__ */ React.createElement(
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: {
          ...
          height: 30,
          borderRadius: 8,
          background: "rgba(126, 224, 192, 0.2)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          color: "var(--mint-text)",
...
function SettingsPage({
  ...
  const anySubSheetOpen = showCleanupSheet;
  useEffect(() => {
  ...
  const [driveRemindMode, setDriveRemindMode] = useState(() => {
    try {
      const raw = localStorage.getItem(GDRIVE_REMIND_DAYS_KEY);
      if (!raw) return "7";
      if (raw === "month-start" || raw === "month-end") return raw;
      const n = parseInt(raw, 10);
      return Number.isFinite(n) ? String(n) : "7";
    } catch {
      return "7";
    }
  });
  ...
  const driveSyncNow = async (silent) => {
    ...
    try {
      ...
      if (!silent) {
        ...
        toastRich({ title: "\u5DF2\u5099\u4EFD\u5230\u96F2\u7AEF", amount: "\u2713", amountColor: "var(--mint)", lines: [`Google Drive \xB7 ${hhmm}`] }, 1600);
      }
    } catch (e) {
      const msg = e && e.message || "\u672A\u77E5\u932F\u8AA4";
      if (!silent) {
  ...
  const setDriveRemind = (mode) => {
    ...
    try {
      localStorage.setItem(GDRIVE_REMIND_DAYS_KEY, String(mode));
    } catch {
    }
  };
  const driveLoadBackupList = async () => {
    ...
    try {
      ...
      if (files.length === 0) toastRich({ title: "\u96F2\u7AEF\u5C1A\u7121\u5099\u4EFD\u6A94", amount: "\u2713", amountColor: "var(--text-faint)", icon: "info", lines: ["\u5148\u7528\u300C\u7ACB\u5373\u5099\u4EFD\u5230\u96F2\u7AEF\u300D\u4E0A\u50B3\u4E00\u4EFD"] }, 2e3);
    } catch (e) {
      toastRich({ title: "\u8B80\u53D6\u5099\u4EFD\u6E05\u55AE\u5931\u6557", amount: "\u2713", amountColor: "var(--pink)", icon: "warn", lines: [cloudErrText(e && e.message)] }, 2200);
      setDriveBackupList(null);
    } finally {
      setDriveSyncing(false);
    }
  };
  const driveDeleteBackup = (fileId, displayTime) => {
    setConfirmDialog({
      title: "\u522A\u9664\u9019\u4EFD\u5099\u4EFD",
      messageList: {
        styled: true,
  ...
  const driveRestoreLatest = async () => {
    ...
    try {
      ...
      const files = await GDrive.listBackups(token);
      if (files.length === 0) {
        toastRich({ title: "\u96F2\u7AEF\u5C1A\u7121\u5099\u4EFD\u6A94", amount: "\u2713", amountColor: "var(--text-faint)", icon: "info", lines: ["\u5148\u7528\u300C\u7ACB\u5373\u5099\u4EFD\u5230\u96F2\u7AEF\u300D\u4E0A\u50B3\u4E00\u4EFD"] }, 2e3);
        setDriveSyncing(false);
        return;
      }
      setDriveSyncing(false);
  ...
  useEffect(() => {
    ...
    if (driveAuto) return;
    try {
      let inst = localStorage.getItem("ledger_install_at");
      if (!inst) {
        inst = String(Date.now());
        localStorage.setItem("ledger_install_at", inst);
      }
      const daysInst = Math.floor((Date.now() - (parseInt(inst, 10) || Date.now())) / 864e5);
      if (daysInst < 7) {
    ...
    _remindShownRef.current = true;
    const now = /* @__PURE__ */ new Date();
    const mode = driveRemindMode || "7";
    let shouldRemind = false;
    let reasonTxt = "";
    if (mode === "month-start" || mode === "month-end") {
      const last = driveLastSync > 0 ? new Date(driveLastSync) : null;
      const backedUpThisMonth = !!last && last.getFullYear() === now.getFullYear() && last.getMonth() === now.getMonth();
      const dom = now.getDate();
      const lastDom = new Date(now.getFullYear(), now.getMonth() + 1, 0).getDate();
      if (mode === "month-start") {
        if (dom <= 5 && !backedUpThisMonth) {
          shouldRemind = true;
          reasonTxt = "\u9019\u500B\u6708\u9084\u6C92\u5099\u4EFD\u5230 Google Drive";
        }
      } else {
        if (dom > lastDom - 5 && !backedUpThisMonth) {
          shouldRemind = true;
          reasonTxt = "\u9019\u500B\u6708\u9084\u6C92\u5099\u4EFD\u5230 Google Drive";
        }
      }
      ...
      if (!(driveLastSync > 0 && elapsed < threshold)) {
        shouldRemind = true;
        reasonTxt = `\u5DF2\u7D93\u8D85\u904E ${days} \u5929 \u6C92\u6709\u5099\u4EFD\u5230 Google Drive`;
      }
    }
...
${reasonTxt},\u8981\u7ACB\u5373\u5099\u4EFD\u55CE?`,
  ...
  return /* @__PURE__ */ React.createElement("div", { style: styles.page }, /* @__PURE__ */ React.createElement("div", { style: styles.pageHeader }, /* @__PURE__ */ React.createElement("h1", { style: styles.pageTitle }, "\u8A2D\u5B9A"), /* @__PURE__ */ React.createElement(EditOrderButton, { editMode, setEditMode })), /* @__PURE__ */ React.createElement(EditModeBanner, { editMode, setEditMode }), /* @__PURE__ */ React.createElement("div", { style: styles.pageScroll }, needsBackup && state.transactions.length > 0 && /* @__PURE__ */ React.createElement("div", { style: styles.backupReminder, onClick: doExport }, /* @__PURE__ */ React.createElement("div", { style: { width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement(TypeIcon, { name: "warning", size: 22, color: "#f5a04a" })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 600, color: "#f5a04a", marginBottom: 2 } }, daysSinceBackup === null ? "\u5EFA\u8B70\u9032\u884C\u9996\u6B21\u5099\u4EFD" : `\u5DF2 ${daysSinceBackup} \u5929\u672A\u5099\u4EFD`), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)" } }, "\u9EDE\u6B64\u7ACB\u5373\u532F\u51FA JSON \u5099\u4EFD")), /* @__PURE__ */ React.createElement("div", { style: styles.settingsArrow }, "\u203A")), (blockOrder || ["dataStat", "appearance", "backup-local", "account", "backup-ext", "cleanup", "danger"]).map((blockKey, idx) => {
    ...
    if (blockKey === "account") {
      ...
      const remindLabel = driveRemindMode === "month-start" ? "\u6BCF\u6708\u521D" : driveRemindMode === "month-end" ? "\u6BCF\u6708\u5E95" : `\u6BCF ${driveRemindMode} \u5929`;
      return /* @__PURE__ */ React.createElement(Block, { key: "account", ...blockProps, title: "\u5E33\u865F\u9023\u7D50" }, !driveLinked ? /* @__PURE__ */ React.createElement(
        ...
        color: "var(--text-dim)",
        lineHeight: 1.6
      } }, "\u5099\u4EFD\u5B58\u5728 Google Drive \u5C08\u5C6C\u7A7A\u9593\u3002\u5728 Drive App \u770B\u4E0D\u5230\u662F\u6B63\u5E38\u7684,\u8981\u67E5\u770B / \u9084\u539F\u8ACB\u7528\u4E0B\u65B9\u300C\u9078\u64C7\u96F2\u7AEF\u5099\u4EFD\u9084\u539F\u300D\u3002"), /* @__PURE__ */ React.createElement(
        "div",
        {
          style: { ...styles.settingsItem, opacity: editMode || driveSyncing ? 0.6 : 1 },
        ...
        marginRight: 4,
        flexShrink: 0
      } }, remindLabel), /* @__PURE__ */ React.createElement("div", { style: styles.settingsArrow }, "\u203A")), /* @__PURE__ */ React.createElement(
        "div",
        {
        ...
        /* @__PURE__ */ React.createElement("div", { style: styles.settingsArrow }, "\u203A")
      ), /* @__PURE__ */ React.createElement("div", { style: styles.settingsItem, onClick: () => !editMode && driveSignOut() }, /* @__PURE__ */ React.createElement("div", { style: styles.settingsIcon }, /* @__PURE__ */ React.createElement(TypeIcon, { name: "link", size: 20, color: "var(--text-faint)" })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { ...styles.settingsLabel, color: "var(--text-dim)" } }, "\u89E3\u9664 Google Drive \u9023\u7D50"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)", marginTop: 2 } }, "\u4E2D\u65B7\u96F2\u7AEF\u540C\u6B65,\u96F2\u7AEF\u5099\u4EFD\u4E0D\u6703\u88AB\u522A\u9664")), /* @__PURE__ */ React.createElement("div", { style: styles.settingsArrow }, "\u203A"))));
    }
    if (blockKey === "dataStat") {
      ...
      const STOCK_MARKET_PALETTE = ["var(--accent-text)", "#d9a25b", "#e07ab0", "#6dc1c9", "#a37bc7"];
      let paletteIdx = 0;
      const colorOfMarket = (m) => {
        if (m.id === "sm_tw") return "var(--mint-text)";
        if (m.id === "sm_us") return "var(--accent-text)";
        const c = STOCK_MARKET_PALETTE[(paletteIdx + 1) % STOCK_MARKET_PALETTE.length];
        paletteIdx++;
        return c;
      };
      const holdingByMarket = stockMarkets.map((m) => {
        ...
        return { label: m.label, color: colorOfMarket(m), count };
      });
      const statRows = [
        {
          key: "txn",
  ...
  ))))), showDriveRemindSetup && /* @__PURE__ */ React.createElement("div", { "data-picker-backdrop": "true", style: styles.pickerBackdrop, onClick: () => setShowDriveRemindSetup(false) }, /* @__PURE__ */ React.createElement("div", { style: styles.pickerCard, onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { style: { padding: "16px 18px 6px", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700 } }, "\u96F2\u7AEF\u5099\u4EFD\u63D0\u9192\u983B\u7387"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)", marginTop: 4, lineHeight: 1.5 } }, "\u81EA\u52D5\u5099\u4EFD\u95DC\u9589\u6642,\u8D85\u904E\u8A2D\u5B9A\u6642\u9593\u6703\u63D0\u9192\u4F60\u624B\u52D5\u5099\u4EFD")), /* @__PURE__ */ React.createElement("div", { style: { padding: "6px 12px 12px" } }, [
    { val: "1", label: "\u6BCF 1 \u5929 \u63D0\u9192" },
    { val: "3", label: "\u6BCF 3 \u5929 \u63D0\u9192" },
    { val: "7", label: "\u6BCF 7 \u5929 \u63D0\u9192" },
    { val: "14", label: "\u6BCF 14 \u5929 \u63D0\u9192" },
    { val: "30", label: "\u6BCF 30 \u5929 \u63D0\u9192" },
    { val: "month-start", label: "\u6BCF\u6708\u521D \u63D0\u9192" },
    { val: "month-end", label: "\u6BCF\u6708\u5E95 \u63D0\u9192" }
  ].map((opt) => {
    const active = driveRemindMode === opt.val;
    return /* @__PURE__ */ React.createElement(
      "div",
      {
        className: "picker-item",
        ...
        style: {
          ...
          cursor: "pointer",
          boxSizing: "border-box",
          background: active ? "rgba(47,170,131,0.12)" : "var(--bg-card-alt)",
          border: active ? "1.5px solid var(--mint)" : "1.5px solid transparent"
        },
        onClick: () => {
          setDriveRemind(opt.val);
          setShowDriveRemindSetup(false);
        }
      },
      /* @__PURE__ */ React.createElement(TypeIcon, { name: "calendar", size: 17, color: active ? "var(--mint-text)" : "var(--text-dim)" }),
      /* @__PURE__ */ React.createElement("div", { style: {
        flex: 1,
        fontSize: 14,
        fontWeight: active ? 700 : 500,
      ...
      active && /* @__PURE__ */ React.createElement(TypeIcon, { name: "check", size: 16, color: "var(--mint-text)" })
    );
...
function AddTxnSheet({ state, type, setType, editing, defaultDate, onSave, onDelete, toast, toastRich, alertCenter, noteColor, onClose, editMode, setEditMode, blockOrder, moveBlock, setPageOrder, onManageCategory, onManageAccount, onAddSubCategory, setConfirmDialog, onOpenStockEntry, reopenOtherTypeTrigger }) {
  ...
  const notePref = useNotePref();
  const DEFAULT_ADD_TXN_ORDER = ["amount", "typeToggle", "date", "category", "subCategory", "account", "fee", "note", "spacer1", "spacer2"];
  const DEFAULT_TRANSFER_ORDER = ["amount", "typeToggle", "date", "fromAccount", "toAccount", "note", "spacer1", "spacer2"];
  const DEFAULT_LEND_ORDER = ["amount", "typeToggle", "date", "fromAccount", "note", "expectDate", "spacer1", "spacer2"];
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetScroll, "data-scroll-container": true }, effectiveOrder.map((blockKey, idx) => {
      ...
      if ((blockKey === "spacer1" || blockKey === "spacer2") && !editing) {
  ...
  if (editing) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: {
        ...
        borderBottom: "1px solid var(--border-soft)",
        marginBottom: 10
      } }, /* @__PURE__ */ React.createElement("div", { style: { ...styles.block, padding: "10px 12px", marginBottom: 0 } }, /* @__PURE__ */ React.createElement("div", { style: { ...styles.fieldLabel, marginTop: 0 } }, "\u540D\u7A31"), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "text",
          style: styles.field,
      ...
      groups.forEach((g) => {
        ...
        rendered.push(
          /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "var(--text-faint)" } }, memberCount, " \u500B"),
...
class ErrorBoundary extends React.Component {
  ...
  static getDerivedStateFromError(error) {
    return { hasError: true, errMsg: error && error.message || String(error) };
  }
  componentDidCatch(error, info) {
    try {
      localStorage.setItem("ledger_last_error_v1", JSON.stringify({
  ...
  render() {
    if (this.state.hasError) {
      return React.createElement(
        ...
        React.createElement("div", { style: { fontSize: 38 } }, "\u26A0\uFE0F"),
        React.createElement("div", { style: { fontSize: 17, fontWeight: 700 } }, "\u756B\u9762\u8F09\u5165\u767C\u751F\u554F\u984C"),
        React.createElement(
          "div",
          { style: { fontSize: 13, color: "#666", lineHeight: 1.7, maxWidth: 300 } },
          "\u5225\u64D4\u5FC3,\u4F60\u7684\u8CC7\u6599\u6C92\u6709\u88AB\u522A\u9664,\u53EA\u662F\u9019\u6B21\u756B\u9762\u7121\u6CD5\u6B63\u5E38\u986F\u793A\u3002\u8ACB\u5148\u5617\u8A66\u91CD\u65B0\u6574\u7406\u3002"
        ),
        ...
        React.createElement(
          ...
          this.state.errMsg ? "\u932F\u8AA4\u8A0A\u606F:" + this.state.errMsg : ""
        )
      );
    }
