...
const DEFAULT_NUM_FONT = "system";
const NUM_FONT_STACKS = {
  // 系統預設:iOS SF Pro / Android Roboto / Windows Segoe UI
  "system": "-apple-system, BlinkMacSystemFont, SF Pro Display, Segoe UI, Roboto, sans-serif",
  // 蘋果裝置等寬:有 SF Mono 用 SF Mono,沒有 fallback 到 Menlo / Monaco
  "sf-mono": "ui-monospace, SF Mono, Menlo, Monaco, monospace",
  // Windows 等寬:Consolas 為主
  "consolas": "Consolas, Cascadia Code, Lucida Console, monospace",
  // Android 等寬:Roboto Mono / Droid Sans Mono
  "roboto-mono": "Roboto Mono, Droid Sans Mono, Cousine, monospace"
};
...
function App() {
  ...
  const [numFont, setNumFont] = useState(() => {
    try {
      return localStorage.getItem(NUM_FONT_KEY) || DEFAULT_NUM_FONT;
    } catch {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Style, { theme, numFont }),
  ...
  return /* @__PURE__ */ React.createElement("div", { style: styles.page }, /* @__PURE__ */ React.createElement("div", { style: styles.pageHeader }, /* @__PURE__ */ React.createElement("h1", { style: styles.pageTitle }, "\u8A2D\u5B9A"), /* @__PURE__ */ React.createElement(EditOrderButton, { editMode, setEditMode })), /* @__PURE__ */ React.createElement(EditModeBanner, { editMode, setEditMode }), /* @__PURE__ */ React.createElement("div", { style: styles.pageScroll }, needsBackup && state.transactions.length > 0 && /* @__PURE__ */ React.createElement("div", { style: styles.backupReminder, onClick: doExport }, /* @__PURE__ */ React.createElement("div", { style: { width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement(TypeIcon, { name: "warning", size: 22, color: "#f5a04a" })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 600, color: "#f5a04a", marginBottom: 2 } }, daysSinceBackup === null ? "\u5EFA\u8B70\u9032\u884C\u9996\u6B21\u5099\u4EFD" : `\u5DF2 ${daysSinceBackup} \u5929\u672A\u5099\u4EFD`), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)" } }, "\u9EDE\u6B64\u7ACB\u5373\u532F\u51FA JSON \u5099\u4EFD")), /* @__PURE__ */ React.createElement("div", { style: styles.settingsArrow }, "\u203A")), (blockOrder || ["backup-local", "backup-ext", "drive", "reminder", "account", "dataStat", "cleanup", "danger"]).map((blockKey, idx) => {
    ...
    if (blockKey === "appearance") {
      return /* @__PURE__ */ React.createElement(Block, { key: "appearance", ...blockProps, title: "\u5916\u89C0" }, /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 4px 8px" } }, /* @__PURE__ */ React.createElement("div", { style: {
        ...
        justifyContent: "space-between",
        marginTop: 14
      } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "var(--text)", fontWeight: 500 } }, "\u6578\u5B57\u5B57\u9AD4"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--text-faint)" } }, "\u9078\u64C7\u624B\u6A5F\u5167\u5EFA\u5B57\u9AD4;\u6C92\u6709\u5247\u81EA\u52D5 fallback")), /* @__PURE__ */ React.createElement(
        "select",
        {
          value: numFont,
          onChange: (e) => !editMode && setNumFont(e.target.value),
          disabled: editMode,
          style: {
            padding: "7px 10px",
            borderRadius: 8,
        ...
        /* @__PURE__ */ React.createElement("option", { value: "system" }, "\u7CFB\u7D71\u9810\u8A2D"),
        /* @__PURE__ */ React.createElement("option", { value: "sf-mono" }, "Apple SF Mono"),
        /* @__PURE__ */ React.createElement("option", { value: "consolas" }, "Microsoft Consolas"),
        /* @__PURE__ */ React.createElement("option", { value: "roboto-mono" }, "Android Roboto Mono")
      )), /* @__PURE__ */ React.createElement("div", { style: {
        marginTop: 10,
        padding: "10px 12px",
        borderRadius: 8,
        ...
        justifyContent: "space-between",
        gap: 12
      } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: "var(--text-faint)" } }, "\u9810\u89BD"), /* @__PURE__ */ React.createElement("span", { style: {
        fontFamily: "var(--num-font)",
        fontSize: 22,
        fontWeight: 700,
        color: "var(--text)",
