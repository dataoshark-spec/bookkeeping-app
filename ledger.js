...
function App() {
  ...
  const handleTouchStart = (e) => {
    ...
    if (sheet || confirmDialog || manageCat || editAccountId || accountsFromAddTxn || periodKey || detailDate || detailAccount || txnSelectMode || homeSelectMode) return;
    if (e.target && e.target.closest && (e.target.closest('[data-sheet="true"]') || e.target.closest("[data-picker-backdrop]"))) return;
    const t = e.touches[0];
  ...
  const saveTxn = (txn) => {
    ...
    setState((s) => {
      if (txn._transfer) {
        ...
        const newTxns2 = [...kept, outTxn, inTxn];
        if (tr.fee > 0) {
          newTxns2.push({
        ...
        return { ...s, transactions: newTxns2 };
      }
      if (txn._lend) {
        const ld = txn._lend;
  ...
  const setStateWithSync2 = React.useCallback((updater) => {
    setState((s) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Style, { theme }),
    ...
    marketValueDialog && (() => {
      ...
      return /* @__PURE__ */ React.createElement("div", { "data-picker-backdrop": "true", style: styles.centerDialogBackdrop, onClick: () => setMarketValueDialog(null) }, /* @__PURE__ */ React.createElement("div", { style: styles.centerDialogCard, onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { style: { padding: "14px 18px", borderBottom: "1px solid var(--border)" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 600 } }, "\u66F4\u65B0 ", h.symbol, " \u76EE\u524D\u5E02\u503C"), h.name && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--text-dim)", marginTop: 2 } }, h.name)), /* @__PURE__ */ React.createElement("div", { style: { padding: 18 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)", marginBottom: 8 } }, "\u6301\u6709 ", shares.toLocaleString(), " \u80A1 \xB7 \u76EE\u524D\u5E02\u503C\u7E3D\u984D(NT$)"), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "number",
          inputMode: "decimal",
      ...
      ), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--text-faint)", marginTop: 6 } }, "\u7CFB\u7D71\u6703\u6839\u64DA\u6B64\u91D1\u984D\u986F\u793A\u6D6E\u52D5\u640D\u76CA")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, padding: "0 14px 14px" } }, /* @__PURE__ */ React.createElement(
        "button",
        {
    ...
    confirmDialog && /* @__PURE__ */ React.createElement(ConfirmDialogRenderer, { dialog: confirmDialog, onClose: () => setConfirmDialog(null) }),
    centerAlert && /* @__PURE__ */ React.createElement(
      "div",
      {
...
function HoldingDetailSheet({ state, holding, onClose, onUpdateMarketValue, onBuyMore, onSell, onDeleteTrade, setConfirmDialog }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetHead }, /* @__PURE__ */ React.createElement(
      ...
      "\u2039"
    ), /* @__PURE__ */ React.createElement("div", { style: { ...styles.sheetTitle, color: "var(--text)" } }, holding.symbol), /* @__PURE__ */ React.createElement("div", { style: { width: 50 } })),
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetScroll }, /* @__PURE__ */ React.createElement("div", { style: {
      margin: "12px 16px",
      padding: "20px 16px",
      borderRadius: 14,
      ...
      border: "1px solid var(--border)",
      textAlign: "center"
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)", marginBottom: 4 } }, shares.toLocaleString(), " \u80A1 \xB7 \u6295\u5165 ", fmt(cost)), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12, fontSize: 11, color: "var(--text-faint)" } }, "\u76EE\u524D\u5E02\u503C"), /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      market > 0 ? fmt(market) : /* @__PURE__ */ React.createElement("span", { style: { color: "var(--mint-text)", fontSize: 18 } }, "\u9EDE\u6B64\u7DE8\u8F2F"),
      /* @__PURE__ */ React.createElement(TypeIcon, { name: "pencil", size: 16, color: "var(--text-faint)" })
    ), market > 0 && cost > 0 && /* @__PURE__ */ React.createElement("div", { style: {
      marginTop: 6,
      fontSize: 14,
      fontWeight: 600,
      color: pnl >= 0 ? "var(--mint-text)" : "var(--pink-text)"
    } }, pnl >= 0 ? "+" : "", fmt(pnl))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, margin: "0 16px 16px" } }, /* @__PURE__ */ React.createElement(
      "button",
      {
      ...
      "\u8CE3\u51FA"
    )), /* @__PURE__ */ React.createElement("div", { style: { margin: "0 16px 16px" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)", marginBottom: 8, paddingLeft: 4, display: "flex", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement("span", null, "\u8CB7\u8CE3\u7D00\u9304(", trades.length, ")"), trades.length > 0 && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "var(--text-faint)" } }, "\u9577\u6309\u53EF\u522A\u9664")), trades.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-faint)", padding: 16, textAlign: "center" } }, "\u5C1A\u7121\u7D00\u9304") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, trades.map((t) => {
...
function TxnListPage({ state, setState, setConfirmDialog, toastRich, toast, catIcon, currentMonth, setCurrentMonth, onClickTxn, editMode, setEditMode, onSelectModeChange, blockOrder, moveBlock, setPageOrder }) {
  ...
  const { monthTxns, inc, exp, sorted, groups, groupKeys } = React.useMemo(() => {
    const _monthTxns = filterMode ? state.transactions.filter((t) => t.date >= fStart && t.date <= fEnd).filter((t) => fType === "all" ? true : t.type === fType).filter((t) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.pageScroll }, order.map((blockKey, idx) => {
      ...
      if (blockKey === "summary") {
        ...
        return /* @__PURE__ */ React.createElement(Block, { key: "summary", ...blockProps, title: /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--mint-text)", fontWeight: 700 } }, scopeChar), scopeLabel, "\u7E3D\u89BD") }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryRow }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryBox }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryLabel }, "\u6536\u5165"), /* @__PURE__ */ React.createElement("div", { style: { ...styles.summaryValue, color: "var(--mint-text)" } }, fmt(inc))), /* @__PURE__ */ React.createElement("div", { style: styles.summaryBox }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryLabel }, "\u652F\u51FA"), /* @__PURE__ */ React.createElement("div", { style: { ...styles.summaryValue, color: "var(--pink-text)" } }, fmt(exp))), /* @__PURE__ */ React.createElement("div", { style: styles.summaryBox }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryLabel }, "\u7D50\u9918"), /* @__PURE__ */ React.createElement("div", { style: { ...styles.summaryValue, color: inc - exp < 0 ? "var(--pink)" : inc - exp > 0 ? "var(--mint)" : "var(--text)" } }, fmtSigned(inc - exp)))));
      }
      if (blockKey === "list") {
        const scopeChar = scope === "day" ? "\u65E5" : scope === "month" ? "\u6708" : "\u5E74";
        return /* @__PURE__ */ React.createElement(
          ...
          sorted.length ? /* @__PURE__ */ React.createElement("div", { style: styles.txnList }, isAmountSort(sortMode) ? (
            // 金額排序:扁平列表(不分組)
            sorted.map((t) => /* @__PURE__ */ React.createElement(
              TxnRow,
              {
                key: t.id,
                txn: t,
    ...
    showFilter && /* @__PURE__ */ React.createElement("div", { "data-picker-backdrop": "true", style: styles.actionMenuBackdrop, onClick: () => setShowFilter(false), ...filterSwipe }, /* @__PURE__ */ React.createElement("div", { style: styles.filterCard, onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { style: styles.actionMenuTitle }, /* @__PURE__ */ React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 8 } }, /* @__PURE__ */ React.createElement(TypeIcon, { name: "search", size: 18, color: "var(--accent-text)" }), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--accent-text)" } }, "\u641C\u5C0B"), /* @__PURE__ */ React.createElement("span", { style: { marginLeft: 2 } }, "\u4EA4\u6613"))), /* @__PURE__ */ React.createElement("div", { style: styles.fieldLabel }, "\u8D77\u59CB\u65E5\u671F"), /* @__PURE__ */ React.createElement(
      ...
      "button",
      {
        ...
        style: {
          ...styles.typeBtn,
          ...fType === opt.v ? opt.v === "income" ? { background: "var(--mint)", color: "var(--on-mint)" } : opt.v === "expense" ? { background: "var(--pink)", color: "var(--on-pink)" } : { background: "var(--accent)", color: "#fff" } : {}
        }
      },
      opt.l
...
function StatsPage({ state, catIcon, currentMonth, setCurrentMonth, editMode, setEditMode, blockOrder, moveBlock, setPageOrder, onClickTxn, onGoToTxn }) {
  ...
  const top5Exp = [...txns].filter((t) => t.type === "expense" && isRealFlow(t)).sort((a, b) => b.amount - a.amount).slice(0, 5);
  const trendData = (() => {
    if (scope === "month") {
      const [y, m] = currentMonth.split("-").map(Number);
  ...
  const renderDonut = (data, total, opts = {}) => {
    ...
    return /* @__PURE__ */ React.createElement("svg", { style: { width: 240, height: 240, overflow: "visible" }, viewBox: "0 0 100 100" }, /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("filter", { id: "donutGlow", x: "-30%", y: "-30%", width: "160%", height: "160%" }, /* @__PURE__ */ React.createElement("feGaussianBlur", { stdDeviation: "0.8", result: "blur" }), /* @__PURE__ */ React.createElement("feMerge", null, /* @__PURE__ */ React.createElement("feMergeNode", { in: "blur" }), /* @__PURE__ */ React.createElement("feMergeNode", { in: "SourceGraphic" }))), /* @__PURE__ */ React.createElement("filter", { id: "centerTextShadow", x: "-20%", y: "-20%", width: "140%", height: "140%" }, /* @__PURE__ */ React.createElement("feGaussianBlur", { in: "SourceAlpha", stdDeviation: "0.4" }), /* @__PURE__ */ React.createElement("feOffset", { dx: "0", dy: "0.3", result: "offsetblur" }), /* @__PURE__ */ React.createElement("feComponentTransfer", null, /* @__PURE__ */ React.createElement("feFuncA", { type: "linear", slope: "0.18" })), /* @__PURE__ */ React.createElement("feMerge", null, /* @__PURE__ */ React.createElement("feMergeNode", null), /* @__PURE__ */ React.createElement("feMergeNode", { in: "SourceGraphic" })))), slices.map((s) => {
      ...
      "text",
      {
        ...
        style: { letterSpacing: "-0.3px", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif" }
      },
    ...
    if (blockKey === "chart") {
      ...
      return /* @__PURE__ */ React.createElement(
        Block,
        {
          ...
          headerRight: drillCat ? /* @__PURE__ */ React.createElement("span", { style: styles.linkMint, onClick: () => {
            setDrillCat(null);
            setSelectedCat(null);
          } }, "\u2190 \u8FD4\u56DE") : null
        },
        ...
        }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--text-faint)", textAlign: "center", marginTop: 8 } }, drillCat ? "\u96D9\u64CA\u5B50\u985E \u2192 \u9032\u660E\u7D30" : "\u96D9\u64CA\u5206\u985E \u2192 \u770B\u5B50\u985E")) : /* @__PURE__ */ React.createElement("div", { style: styles.empty }, "\u6C92\u6709\u8CC7\u6599")
      );
    }
    if (blockKey === "trend") {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: styles.page }, /* @__PURE__ */ React.createElement("div", { style: styles.pageHeader }, /* @__PURE__ */ React.createElement("h1", { style: styles.pageTitle }, "\u8A2D\u5B9A"), /* @__PURE__ */ React.createElement(EditOrderButton, { editMode, setEditMode })), /* @__PURE__ */ React.createElement(EditModeBanner, { editMode, setEditMode }), /* @__PURE__ */ React.createElement("div", { style: styles.pageScroll }, needsBackup && state.transactions.length > 0 && /* @__PURE__ */ React.createElement("div", { style: styles.backupReminder, onClick: doExport }, /* @__PURE__ */ React.createElement("div", { style: { width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center" } }, /* @__PURE__ */ React.createElement(TypeIcon, { name: "warning", size: 22, color: "#f5a04a" })), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 600, color: "#f5a04a", marginBottom: 2 } }, daysSinceBackup === null ? "\u5EFA\u8B70\u9032\u884C\u9996\u6B21\u5099\u4EFD" : `\u5DF2 ${daysSinceBackup} \u5929\u672A\u5099\u4EFD`), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)" } }, "\u9EDE\u6B64\u7ACB\u5373\u532F\u51FA JSON \u5099\u4EFD")), /* @__PURE__ */ React.createElement("div", { style: styles.settingsArrow }, "\u203A")), (blockOrder || ["backup-local", "backup-ext", "drive", "reminder", "account", "dataStat", "cleanup", "danger"]).map((blockKey, idx) => {
    ...
    if (blockKey === "appearance") {
      return /* @__PURE__ */ React.createElement(Block, { key: "appearance", ...blockProps, title: "\u5916\u89C0" }, /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 4px 8px" } }, /* @__PURE__ */ React.createElement("div", { style: {
        ...
        alignItems: "center",
        justifyContent: "space-between"
      } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 2 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, color: "var(--text)", fontWeight: 500 } }, "\u4E3B\u984C"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--text-faint)" } }, "\u5207\u63DB\u6DF1\u8272\u6216\u6DFA\u8272\u98A8\u683C")), /* @__PURE__ */ React.createElement("div", { style: {
        display: "flex",
        background: "var(--bg-card)",
        border: "1px solid var(--border)",
        borderRadius: 10,
...
function FilterDeleteSheet({ state, setState, onClose, setConfirmDialog, toast, toastRich }) {
  ...
  const renderConditionUI = () => {
    ...
    if (filterType === "amount") {
      return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } }, /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "number",
          inputMode: "numeric",
      ...
      ), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--text-dim)" } }, "~"), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "number",
          inputMode: "numeric",
...
const TxnRow = React.memo(function TxnRow2({ txn, state, catIcon, onClick, onLongPress, selectMode, selected }) {
  const acct = state.accounts.find((a) => a.id === txn.accountId);
...
function AddTxnSheet({ state, type, setType, editing, defaultDate, onSave, onDelete, toast, toastRich, alertCenter, noteColor, onClose, editMode, setEditMode, blockOrder, moveBlock, onManageCategory, onManageAccount, onAddSubCategory, setConfirmDialog, onOpenStockEntry }) {
  ...
  const effectiveOrder = rawOrder.includes("note") ? rawOrder : (() => {
    const out = [...rawOrder];
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    showOtherTypeSheet && /* @__PURE__ */ React.createElement("div", { "data-picker-backdrop": "true", style: styles.pickerBackdrop, onClick: () => setShowOtherTypeSheet(false) }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8, padding: "8px 12px 16px" } }, /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 600 } }, "\u80A1\u7968\u7D50\u7B97"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--text-dim)", marginTop: 2 } }, "\u8CB7\u9032\u3001\u8CE3\u51FA\u3001\u4F30\u5E02\u503C"))
      ))
    )),
    ...
    showFeeCatPicker && /* @__PURE__ */ React.createElement("div", { "data-picker-backdrop": "true", style: styles.pickerBackdrop, onClick: () => setShowFeeCatPicker(false) }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { ...styles.pickerTitle, display: "flex", alignItems: "center", gap: 8, padding: "12px 12px 12px 12px" } }, feeCatStep === 2 ? /* @__PURE__ */ React.createElement(
        "button",
        {
          style: {
            background: "var(--bg-card)",
      ...
      ) : /* @__PURE__ */ React.createElement("div", { style: { width: 66 } }), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, textAlign: "center", fontSize: 15, fontWeight: 600 } }, feeCatStep === 1 ? /* @__PURE__ */ React.createElement(React.Fragment, null, "\u9078\u64C7 ", /* @__PURE__ */ React.createElement("span", { style: { color: "#f5d84a" } }, "\u5927\u5206\u985E")) : /* @__PURE__ */ React.createElement(React.Fragment, null, "\u7FA4\u7D44 ", /* @__PURE__ */ React.createElement("span", { style: { color: "#f5d84a" } }, "\u5B50\u5206\u985E"))), /* @__PURE__ */ React.createElement("div", { style: { width: 66 } })),
      /* @__PURE__ */ React.createElement("div", { style: {
      ...
      /* @__PURE__ */ React.createElement("div", { style: { ...styles.pickerList, maxHeight: "55vh", padding: "0 8px 12px" } }, feeCatStep === 1 ? (
        ...
        (() => {
          ...
          return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement("div", { style: { ...styles.pickerItemLabel, color: "#6aa8f0", fontSize: 15 } }, "(\u4E0D\u6307\u5B9A\u5B50\u5206\u985E)"),
...
function PeriodDetailSheet({ state, setState, catIcon, periodKey, onClose, onClickTxn, setConfirmDialog, toastRich, toast }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetScroll, "data-scroll-container": true }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", color: "var(--text-dim)", fontSize: 13, marginBottom: 14 } }, range), blockOrder.map((blockKey, idx) => {
      ...
      if (blockKey === "list") {
        return /* @__PURE__ */ React.createElement(Block, { key: "list", ...blockProps }, txns.length ? /* @__PURE__ */ React.createElement("div", { style: styles.txnList }, groupKeys.map((date) => {
          const days = groups[date];
          ...
          const wd = ["\u65E5", "\u4E00", "\u4E8C", "\u4E09", "\u56DB", "\u4E94", "\u516D"][new Date(date).getDay()];
          return /* @__PURE__ */ React.createElement(React.Fragment, { key: date }, /* @__PURE__ */ React.createElement("div", { style: styles.groupDate }, /* @__PURE__ */ React.createElement("span", null, date.replace(/-/g, "/"), " \xB7 \u9031", wd), /* @__PURE__ */ React.createElement("span", { style: styles.groupDateAmt }, dInc > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "var(--mint-text)" } }, "+", fmt(dInc), " "), dExp > 0 && /* @__PURE__ */ React.createElement("span", { style: { color: "var(--pink-text)" } }, "-", fmt(dExp)))), days.map((t) => /* @__PURE__ */ React.createElement(
            TxnRow,
            {
              key: t.id,
              txn: t,
...
function DayDetailSheet({ state, catIcon, date, onClose, onClickTxn, onAdd }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetScroll, "data-scroll-container": true }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", color: "var(--text-dim)", fontSize: 14, marginBottom: 14 } }, date.replace(/-/g, "/"), " \xB7 \u9031", wd), blockOrder.map((blockKey, idx) => {
      ...
      if (blockKey === "summary") {
        return /* @__PURE__ */ React.createElement(Block, { key: "summary", ...blockProps }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryRow }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryBox }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryLabel }, "\u6536\u5165"), /* @__PURE__ */ React.createElement("div", { style: { ...styles.summaryValue, color: "var(--mint-text)" } }, fmt(inc))), /* @__PURE__ */ React.createElement("div", { style: styles.summaryBox }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryLabel }, "\u652F\u51FA"), /* @__PURE__ */ React.createElement("div", { style: { ...styles.summaryValue, color: "var(--pink-text)" } }, fmt(exp))), /* @__PURE__ */ React.createElement("div", { style: styles.summaryBox }, /* @__PURE__ */ React.createElement("div", { style: styles.summaryLabel }, "\u7D50\u9918"), /* @__PURE__ */ React.createElement("div", { style: { ...styles.summaryValue, color: inc - exp < 0 ? "var(--pink)" : inc - exp > 0 ? "var(--mint)" : "var(--text)" } }, fmtSigned(inc - exp)))), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: 14 } }, /* @__PURE__ */ React.createElement("button", { style: styles.addIncBtn, onClick: () => !editMode && onAdd("income", date) }, "\uFF0B \u65B0\u589E\u6536\u5165"), /* @__PURE__ */ React.createElement("button", { style: styles.addExpBtn, onClick: () => !editMode && onAdd("expense", date) }, "\uFF0B \u65B0\u589E\u652F\u51FA")));
      }
      if (blockKey === "list") {
...
function AccountDetailSheet({ state, catIcon, account, onClose, onClickTxn, onSell, onBuyHolding, onSellHolding, onUpdateMarketValue, onOpenHolding }) {
  ...
  let txns;
  if (filterMode) {
    txns = state.transactions.filter((t) => t.accountId === account.id).filter((t) => t.date >= fStart && t.date <= fEnd).filter((t) => fType === "all" ? true : t.type === fType).filter((t) => {
      if (!fKeyword.trim()) return true;
      const kw = fKeyword.trim().toLowerCase();
  ...
  React.useEffect(() => {
    try {
      localStorage.setItem("ledger_account_order", JSON.stringify(blockOrder));
    } catch {
    }
  }, [blockOrder]);
  const moveBlock = (key, dir) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetHead }, /* @__PURE__ */ React.createElement("div", { style: { width: 50 } }), /* @__PURE__ */ React.createElement("div", { style: styles.sheetTitle }, account.name), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, minWidth: 50, justifyContent: "flex-end" } }, !editMode && /* @__PURE__ */ React.createElement(
      "button",
      {
        style: {
          ...styles.editOrderBtn,
    ...
    /* @__PURE__ */ React.createElement("div", { style: styles.sheetScroll, "data-scroll-container": true }, blockOrder.map((blockKey, idx) => {
      ...
      if (blockKey === "holdings" && account.type === "invest" && (account.investSubType || "stock") === "stock") {
        ...
        return /* @__PURE__ */ React.createElement(Block, { key: "holdings", ...blockProps }, /* @__PURE__ */ React.createElement("div", { style: {
          ...
          color: "var(--text-faint)",
          fontSize: 13
        } }, "\u5C1A\u672A\u6301\u6709\u4EFB\u4F55\u80A1\u7968") : /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, activeHoldings.map((h) => {
          const shares = holdingShares(h, state.trades);
          ...
          return /* @__PURE__ */ React.createElement(
            ...
            /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700 } }, h.symbol), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--text-dim)", marginTop: 4 } }, shares.toLocaleString(), " \u80A1")),
            /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right" } }, market > 0 ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: "var(--text-dim)" } }, "\u5E02\u503C"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, fontWeight: 600 } }, fmt(market))) : /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: "var(--mint-text)" } }, "\u9EDE\u6B64\u7DE8\u8F2F\u5E02\u503C")),
            /* @__PURE__ */ React.createElement("div", { style: { fontSize: 18, color: "var(--text-faint)" } }, "\u203A")
          );
        })), /* @__PURE__ */ React.createElement(
          "button",
      ...
      if (blockKey === "list") {
        return /* @__PURE__ */ React.createElement(Block, { key: "list", ...blockProps }, txns.length === 0 ? /* @__PURE__ */ React.createElement("div", { style: styles.emptyAccountHint }, filterMode ? "\u7121\u7B26\u5408\u689D\u4EF6\u7684\u4EA4\u6613" : "\u672C\u6708\u66AB\u7121\u4EA4\u6613") : /* @__PURE__ */ React.createElement("div", { style: styles.txnList }, txns.map((t) => /* @__PURE__ */ React.createElement(
          TxnRow,
          {
            key: t.id,
            txn: t,
  ...
  const save = () => {
    ...
    if (initAmtChanged && setConfirmDialog) {
      ...
      const bullets = [
        ...
        relatedTxnCount > 0 ? `\u2022 \u6B64\u5E33\u6236\u6709 ${relatedTxnCount} \u7B46\u7D00\u9304,\u7576\u524D\u9918\u984D\u6703\u8DDF\u8457\u8B8A\u52D5` : `\u2022 \u6B64\u5E33\u6236\u76EE\u524D\u6C92\u6709\u7D00\u9304,\u8B8A\u66F4\u5F8C\u76F4\u63A5\u53CD\u6620\u5728\u9918\u984D`,
        "\u2022 \u6B64\u52D5\u4F5C\u7121\u6CD5\u5FA9\u539F"
      ];
      setConfirmDialog({
        title: "\u8B8A\u66F4 \u521D\u59CB\u91D1\u984D",
      ...
      const blockEl = /* @__PURE__ */ React.createElement(
        ...
        /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("div", { style: styles.txnInfo }, /* @__PURE__ */ React.createElement("div", { style: styles.txnCat }, a.name, a.virtual && /* @__PURE__ */ React.createElement("span", { style: {
            ...
            background: "rgba(126, 224, 192, 0.12)",
            verticalAlign: "middle"
          } }, "\u865B\u64EC")), /* @__PURE__ */ React.createElement("div", { style: styles.txnMeta }, typeMeta.label, " \xB7 \u9918\u984D ", /* @__PURE__ */ React.createElement("span", { style: { color: balColor, fontWeight: bal !== 0 ? 600 : 400 } }, balDisplay), investSummary && investSummary.totalCost > 0 && /* @__PURE__ */ React.createElement("span", { style: {
            marginLeft: 8,
...
\u78BA\u5B9A\u8981\u7E7C\u7E8C\u55CE?`,
          ...
          /* @__PURE__ */ React.createElement("ul", { style: {
            ...
            lineHeight: 1.7,
            listStyle: "disc"
          } }, /* @__PURE__ */ React.createElement("li", null, "\u6536\u652F\u7D00\u9304\u4FDD\u7559,\u4E26\u6A19\u793A\u300C\u5E33\u865F\u5DF2\u522A\u300D"), /* @__PURE__ */ React.createElement("li", null, "\u7D71\u8A08\u6578\u5B57\u4E0D\u53D7\u5F71\u97FF"), info.balance !== 0 && /* @__PURE__ */ React.createElement("li", null, "\u5E33\u6236\u9918\u984D ", balanceText, " \u5F9E\u7E3D\u8CC7\u7522\u6263\u9664"))
        ), /* @__PURE__ */ React.createElement(
          "button",
          {
            disabled: deleteModeLocked,
...
\u78BA\u5B9A\u8981\u7E7C\u7E8C\u55CE?`,
          ...
          /* @__PURE__ */ React.createElement("ul", { style: {
            ...
            lineHeight: 1.7,
            listStyle: "disc"
          } }, /* @__PURE__ */ React.createElement("li", null, fullDeleteFirstBullet), /* @__PURE__ */ React.createElement("li", null, "\u7D71\u8A08\u9801\u7684\u6B77\u53F2\u6536\u652F\u6703\u8DDF\u8457\u7E2E\u6C34"), /* @__PURE__ */ React.createElement("li", null, "\u6B64\u52D5\u4F5C\u7121\u6CD5\u5FA9\u539F"))
        )), /* @__PURE__ */ React.createElement(
          "div",
          {
            onClick: () => setDeleteModeChoice(null),
...
const styles = {
  ...
  summaryValue: { fontSize: 17, fontWeight: 700, fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif", letterSpacing: "-0.5px" },
  // 日期橫條（前3天 + 今天 + 後3天）
  dateStripCard: {
    background: "var(--bg-card)",
    borderRadius: 18,
  ...
  periodRange: { fontSize: 11, color: "var(--text-faint)", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif" },
  periodRight: { textAlign: "right", display: "flex", flexDirection: "column", gap: 2 },
  periodIncAmt: { fontSize: 12, fontWeight: 600, color: "var(--mint-text)", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif" },
  periodExpAmt: { fontSize: 12, fontWeight: 600, color: "var(--pink-text)", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif" },
  ...
  txnAmt: { fontSize: 16, fontWeight: 600, whiteSpace: "nowrap", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif" },
  empty: {
    textAlign: "center",
    padding: "32px 20px",
    color: "var(--text-faint)",
  ...
  legendAmt: { minWidth: 64, textAlign: "right", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif", fontSize: 13, fontWeight: 500 },
  // 設定
  ...
  statValue: { fontSize: 12, color: "var(--text)", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', 'Segoe UI', Roboto, sans-serif", fontVariantNumeric: "tabular-nums" },
  // 第三方連結卡
  thirdPartyCard: {
    display: "flex",
    alignItems: "center",
